...
<body><center><br>
	...
	<table border="1" cellspacing="0" cellpadding="5">
		<tr align="center">
					<td colspan="6"	bgcolor="#C0C0C0">사원 정보 검색</td>
		<tr align="center">
					<td bgcolor="#C0C0C0">키워드</td>
					<td><input type="text" name="dev_name" size=20 maxlength=10></td>
					<td bgcolor="#C0C0C0">성별</td>
	                <td><input type="checkbox" name="gender" value="남">남
			...
			<tr align="center">
	            ...
	            <td>
		            <input type="checkbox" name="school" value="고졸">고졸
		            <input type="checkbox" name="school" value="전문대졸">전문대졸
		            <input type="checkbox" name="school" value="일반대졸">일반대졸
